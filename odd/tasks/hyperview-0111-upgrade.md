...
User: review the local code and complete native-device acceptance. The fifth candidate was declined without a native approval; its earlier transaction remains preserved and must not be reported as closed. No repeat provider-choice prompt is needed. Push or release still requires separate authorization.
